    ...
    <section className="py-16 lg:py-24 px-6 lg:px-20 relative overflow-hidden bg-charcoal">
      <div className="relative max-w-[800px] mx-auto text-center">
        <FadeIn duration={0.8}>
          {variant === 'quote' && (
            <>
              <blockquote className="font-display text-[24px] sm:text-[32px] lg:text-[40px] font-light text-cream/90 leading-[1.3] tracking-wide italic">
                {quote}
              </blockquote>
              {attribution && (
          ...
          {variant === 'philosophy' && (
            <>
              <p className="font-display text-[44px] lg:text-[64px] font-light text-cream/10 mb-4">
                内外
              </p>
              <h2 className="font-display text-[24px] lg:text-[32px] font-light text-cream leading-[1.3]">
                Inside and outside
              </h2>
