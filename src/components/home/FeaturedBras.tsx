          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="pt-5 pb-5 border-b border-sand">
                ...
                <h3 className="font-display text-[20px] font-light text-ink mt-2 leading-[1.2] whitespace-pre-line">
                  {product.name}
                </h3>
                ...
                <div className="pt-6 pb-6 border-b border-stone/20">
                  <div className="flex items-start justify-between gap-8">
                    <div className="flex-1 min-w-0">
                      ...
                      <h3 className="font-display text-[24px] xl:text-[28px] font-light text-ink mt-3 leading-[1.15] whitespace-pre-line">
                        {product.name}
                      </h3>
